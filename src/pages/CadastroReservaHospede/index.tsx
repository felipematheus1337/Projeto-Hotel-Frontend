...
const CadastrarReservaHospede = () => {
    ...
    const handleCreateHotel = async (e:FormEvent) => {
       ...
       console.log(hospedesObj)

        let response = await api('POST', '/cadastrarReservaHospede',reservaHospedeObj);
    ...
    return (
        <C.Container>
            <C.Form onSubmit={handleCreateHotel}>
                <h2>Cadastro de Reserva Hospede</h2>
...
export default CadastrarReservaHospede;